...
cp -f "$SITL_MODELS_DIR/Ignition/scripts/daf_xf_450_tractor_mixer.lua" sitl/tractor/scripts

TRACTOR_DEFAULTS="$SITL_MODELS_DIR/Ignition/config/daf_xf_450_tractor.param"
